...
Copy and Paste this prompt into ChatGPT. This prompt will only take one argument in order to run.
...
### If there are any bugs create a Bug report and I will try and fix it. 